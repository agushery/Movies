 ...
 *
 *  - Parameters:
 *      - data: An array of `PopularMovieModel` objects that represent the movie data that will be displayed in the grid.
 *  - Properties:
 ...
 *
 *  - Example usage:
 *      - let popularMovieData = [PopularMovieModel.dummyData, PopularMovieModel.dummyData]
...
struct PopularMovieView_Previews: PreviewProvider {
    static var previews: some View {
        PopularMovieView(data: [PopularMovieModel.dummyData])
    }
}
